      ...
      <div className="max-w-2xl mx-auto px-8">
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center gap-6 text-gray-600">
            <a 
              href="mailto:mahir.mahtab@example.com" 
            ...
            >
              ...
              <span className="hidden sm:inline">mahir.mahtab@example.com</span>
            </a>
            <a 
              href="https://github.com/mahirmahtab" 
              className="flex items-center gap-2 hover:text-gray-800 transition-colors"
              target="_blank"
            ...
            <a 
              href="https://twitter.com/mahirmahtab" 
              className="flex items-center gap-2 hover:text-gray-800 transition-colors"
              target="_blank"
              rel="noopener noreferrer"
              title="Twitter"
            ...
            <a 
              href="https://linkedin.com/in/mahirmahtab" 
              className="flex items-center gap-2 hover:text-gray-800 transition-colors"
              target="_blank"
              rel="noopener noreferrer"
              title="LinkedIn"
          ...
          <div className="text-xs text-gray-500 pt-4 border-t border-gray-200">
            © 2025 Mahir Mahtab. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
